...
fn effect(input: EffectInput, params: EffectParams) -> vec4<f32> {
    ...
    let row_angle = base_angle + grab_offset * turn * (0.14 + radius * 0.36);
    let curvature = -(0.022 + radius * 0.62) * turn * page_width * 2.0
    ...
    if (on_sheet) {
        ...
        let light = normalize(vec3<f32>(0.3, -0.28, 0.9));
        ...
        let self_shadow = clamp(local_fold * 0.34, 0.0, 0.2);
        ...
        // the gutter.
        let shadow_width = 0.012 + radius * 0.065 + turn * 0.016;
